...
namespace Sitecore.Support.ContentSearch.SolrProvider
{
    ...
    public class SwitchOnRebuildSolrSearchIndex : Sitecore.ContentSearch.SolrProvider.SwitchOnRebuildSolrSearchIndex, IFailResistantIndex
    {
        ...
        protected static readonly Type switchOnRebuildSolrSearchIndexType = typeof(Sitecore.ContentSearch.SolrProvider.SwitchOnRebuildSolrSearchIndex);
        ...
        public override void Initialize()
        {
            ...
            var tempSolrOperations = ServiceLocator.Current.GetInstance<ISolrOperations<Dictionary<string, object>>>(this.RebuildCore);
            ReflectionHelper.SetValueToPrivateField(switchOnRebuildSolrSearchIndexType, this, "tempSolrOperations", tempSolrOperations);
